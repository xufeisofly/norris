...
ActiveRecord::Schema.define(version: 2018_11_14_231507) do
  ...
  create_table "blue_space_conversations", force: :cascade do |t|
    ...
    t.integer "next_id"
    t.index ["next_id"], name: "index_blue_space_conversations_on_next_id"
  ...
  create_table "blue_space_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "blue_space_id"
    t.index ["blue_space_id"], name: "index_blue_space_logs_on_blue_space_id"
